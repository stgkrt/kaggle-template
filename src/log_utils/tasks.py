...
from src.log_utils import pylogger, rich_utils
...
def extras(config: DictConfig) -> None:
    ...
    Args:
        config: A DictConfig object containing the config tree.
    """
...
def task_wrapper(task_func: Callable) -> Callable:
    """Optional decorator that controls the failure behavior
        when executing the task function.
    ...
    def wrap(config: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        # things to do if exception occurs
            ...
            # some hyperparameter combinations might
            # be invalid or cause out-of-memory errors
        ...
        # things to always do after either success or exception
            ...
            log.info(f"Output dir: {config.dir.output_dir}")
