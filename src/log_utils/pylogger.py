...
class RankedLogger(logging.LoggerAdapter):
    ...
    def __init__(
        ...
        Args:
            ...
            rank_zero_only (bool): Whether to force all logs to only occur
                                    on the rank zero process. Defaults to False.
            extra (Optional[Mapping[str, object]]): A dict-like object which provides
    ...
    def log(  # type: ignore
        ...
        Args:
            level (int): The level to log at.
                         Look at `logging.__init__.py` for more information.
            msg (str): The message to log.
            rank (int | None): The rank to log at.
            args: Additional args to pass to the underlying logging function.
            kwargs: Any additional keyword args to pass
                    to the underlying logging function.
        """
